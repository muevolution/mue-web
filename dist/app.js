...
const socketio = __webpack_require__(22);
const common_1 = __webpack_require__(44);
const config_1 = __webpack_require__(45);
const webInput = document.getElementById("input");
const webSubmit = document.getElementById("send");
const webOutput = document.getElementById("output");
...
function connect() {
    ...
    let authInfo = null;
    const sSocket = socketio(config_1.config.target_url);
    const tsock = new common_1.TypedEmitter(sSocket);
...
class BaseTypedEmitter {
    ...
    on(event, listener, errorHandler) {
...
exports.BaseTypedEmitter = BaseTypedEmitter;
class TypedEmitter extends BaseTypedEmitter {
}
